...
def prepare_data_for_RNN(dataset):
    ...
    #Removed: , 'numberOfSharedNouns'
    sharedFeatures = x_dataFrame.as_matrix(columns=['claimIndicatorArg1', 'premiseIndicatorArg1','claimIndicatorArg2', 'premiseIndicatorArg2','sameSentence', 'sharedNouns', 'tokensArg1', 'tokensArg2'])
